  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow px-4 py-10 max-w-6xl mx-auto space-y-10 text-gray-800">
        ...
        >
          <img
            src="/img/services/shipping-management.png"
          ...
          <section className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <img src="/img/services/west_africa_coverage.png" alt="Shipping Office" className="rounded-lg object-cover w-full md:h-80 h-full" />
            </div>
